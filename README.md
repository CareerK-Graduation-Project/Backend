...
- `PATCH /api/bookmarks/:post_id` – Bookmark a job/service post (Auth: Developer)
...
- `PATCH /api/course-enrollment/enroll/:courseId` – Enroll in a course (Auth: Logged-in user)
- `PATCH /api/course-enrollment/lessons/complete` – Mark a lesson as complete (Auth: Logged-in user)
...
- ` PATCH /api/course-bookmarks/:courseId/bookmark` – Bookmark/unbookmark a course (param: { courseId }) (Auth: Logged-in user)
